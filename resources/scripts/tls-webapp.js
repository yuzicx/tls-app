...
$(function() {
    console.log( "ready!" );
    try {
     $("#blue-eye").attr("title", TLSI18n.fromSource("Press here to show annotations."));
    } catch (err) {}
  ...
  $.ajax({
   ...
   success : function(resp){
    ...
    for (var prop in obj) {
     ...
     if (aiclass == 'ai ') {
         $(line_id).parent().attr('title', TLSI18n.fromSource('Translation generated by AI'));
     } else {
...
function zh_start_edit(){
    ...
    $("#blue-eye").attr("title", TLSI18n.fromSource("Click here to end editing"));
